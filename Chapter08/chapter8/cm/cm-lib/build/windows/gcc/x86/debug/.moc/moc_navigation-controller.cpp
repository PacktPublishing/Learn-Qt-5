...
void cm::controllers::NavigationController::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            typedef void (NavigationController::*_t)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&NavigationController::goRssView)) {
                *result = 4;
                return;
            }
        }
...
// SIGNAL 4
void cm::controllers::NavigationController::goRssView()
{
